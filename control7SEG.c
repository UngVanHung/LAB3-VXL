...
void segRun1() {
	update7SEG_Mode(MODE_0_7SEG, ModeofLED);
	update7SEG_Value(VALUE_0_7SEG, ValueofLED);
}

void segRun2() {
	update7SEG_Mode(MODE_1_7SEG, ModeofLED);
	update7SEG_Value(VALUE_1_7SEG, ValueofLED);
}
