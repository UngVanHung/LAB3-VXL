#include "button.h"
#include "main.h"
static int buttonBuffer[NUM_OF_BUTTONS];
static int debounceButtonBuffer1[NUM_OF_BUTTONS];
static int debounceButtonBuffer2[NUM_OF_BUTTONS];
static int longPressButtonBuffer[NUM_OF_BUTTONS];
